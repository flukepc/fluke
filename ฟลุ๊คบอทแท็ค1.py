...
cl = LINETCR.LINE()
cl.login(token="ErZ4aNshO2UT0Up6Ju1e.zQPTHlF6iJWp+Wd7/4cEhG.qB4XXdu/rm+4EwnWou4ld+om5hWJIFMICL3kGQc/efk=")
cl.loginResult()
ki=ki2=ki3=ki4=cl
...
║➣͜™ധ.ざ.🔝ɕღ็௮ღีњ★
╠══════════════════
║【รายการคำสั่งการใช้งาน】  
╠══════════════════
║             👉 [มาจ้า] 👈
║[ลงคำสั่งนี้เพื่อแท๊กสมาชิค]
╠══════════════════
║          [คำสั่งเพือค้นหาเพลง]
║                👉 [ยูทูป] 👈
║                   [ตัวอย่าง]
║       ยูทูป วันหนึ่งฉันเดินเข้าป่า
╠══════════════════
║   👉 [คำสั่งเช็คคนแอบอ่าน] 👈
║            👉 ตั้งเวลา 👈
║              [นับ 5 วิแล้วพิม]
...
KAC=[cl]
mid = cl.getProfile()["u66aa6d84b7fa223c0fff00fbfb809e1e"]
bot1 = cl.getProfile()["u66aa6d84b7fa223c0fff00fbfb809e1e"]
...
#-----------------------------------------------
        if op.type == 17:
            ...
            cb = Message()
            cb.to = op.param1
            cb.text = cl.getContact(op.param2).displayName + "สวัดดีครับสมาชิคใหม่\nเข้ามาแล้วอ่านโน๊ตด้วยนะ\nแนะนำตัวเองลงโน๊ตด้วย\nอย่าลืมปิดแจ้งเตือนล่ะ\nสนใจทำ SELF BOT&Kickerหรือติดบอทติดต่อเราได้ที่\nŦ€₳ℳ฿❂Ŧ🔝ҨัՁਙุЮℓℓ丂ს\nhttp://line.me/ti/p/~antmod.\n[BY:] Ҩఖণಖஇ↭ধัюӄՁ่গს\n★★★★★★★★★★★★"
            cl.sendMessage(cb)

        if op.type == 15:
            if op.param2 in Bots:
                return
            cl.sendText(op.param1, "😁กำจัง..จะรีบไปไหน😁\n😈ไว้โอกาสหน้าค่อยเจอกันใหม่น่ะจ๊ะ😈\n😊ติดต่อเราได้ที่😊\nŦ€₳ℳ฿❂Ŧ🔝ҨัՁਙุЮℓℓ丂ს\n[BY:] Ҩఖণಖஇ↭ধัюӄՁ่গს\nhttp://line.me/ti/p/~antmod.\n★★★★★★★★★★★★")
            print "MemberLeft"
#----------------------------------------------- 
#------------------------------------------------------------------------------------
